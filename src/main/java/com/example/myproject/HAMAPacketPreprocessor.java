 ...
 * </pre>
 */
public class HAMAPacketPreprocessor extends org.yamcs.tctm.CcsdsPacketPreprocessor  {
    ...
    public HAMAPacketPreprocessor(String yamcsInstance) {
        this(yamcsInstance, YConfiguration.emptyConfig());
    }

    // Constructor used when this preprocessor is used with YAML configuration
    // (packetPreprocessorClassArgs)
    public HAMAPacketPreprocessor(String yamcsInstance, YConfiguration config) {
